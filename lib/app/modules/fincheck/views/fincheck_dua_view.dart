...
class FincheckDuaView extends GetView {
  FincheckDuaView({Key? key}) : super(key: key);
          ...
          SizedBox(
            ...
            child: Column(
              ...
              children: [
                ...
                const FieldFincheck(labelText: "Menabung dan Investasi"),
                const FieldFincheck(labelText: "Total tabungan kamu saat ini"),
              ],
            ),
          ),
          SizedBox(
