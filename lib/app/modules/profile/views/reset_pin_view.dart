...
class ResetPinView extends GetView {
  ResetPinView({Key? key}) : super(key: key);
  final c = Get.find<EditPinController>(tag: 'setel-ulang-pin');
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Obx(
                          () => TextField(
                            autocorrect: false,
                            obscureText: c.resetPIN.value,
                            controller: c.resetPINC,
                      ...
                      Container(
                        ...
                        child: Obx(
                          () => TextField(
                            autocorrect: false,
                            obscureText: c.conResetPIN.value,
                            controller: c.conResetPINC,
                            cursorColor: buttonColor1,
                            ...
                            decoration: InputDecoration(
                              ...
                              focusedBorder: OutlineInputBorder(
                                  ...
                                  borderRadius: BorderRadius.circular(20)),
                              suffixIcon: IconButton(
                                onPressed: () => c.conResetPIN.toggle(),
                                icon: Iconify(
                                  c.conResetPIN.isTrue
                                      ? MdiLight.eye_off
                                      : MdiLight.eye,
                                  color: grey400,
                                ),
            ...
            Container(
              ...
              child: Obx(
                () => ElevatedButton(
                  ...
                  onPressed: () {
                    if (c.isLoadingResetPIN.isFalse) {
                      c.forgotPIN();
                    }
                  },
                  child: c.isLoadingResetPIN.isFalse
                      ? Text(
                          'Simpan',
                          style: Theme.of(context)
                              .textTheme
